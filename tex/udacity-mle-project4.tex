...
The driving agent's state should be made up of elements in the environment that can facilitate proper decision making.
...
The next waypoint and deadline state values will be needed to help evolve the system learning, since they are related to higher level goals.
